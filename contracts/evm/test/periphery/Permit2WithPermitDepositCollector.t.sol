...
contract Permit2WithPermitDepositCollectorTest is Test {
    Permit2WithPermitDepositCollector public collector;
    ...
    function setUp() public {
        ...
        collector = new Permit2WithPermitDepositCollector(address(mockPermit2));
    ...
    function _makeCollectorData(uint256 amount) internal view returns (bytes memory) {
        Permit2WithPermitDepositCollector.EIP2612Permit memory permit2612 =
            Permit2WithPermitDepositCollector.EIP2612Permit({
                value: amount,
    ...
    function test_constructor_revert_zeroPermit2() public {
        ...
        new Permit2WithPermitDepositCollector(address(0));
    }
    ...
    function test_collect_revert_amountMismatch() public {
        ...
        vm.expectRevert(Permit2WithPermitDepositCollector.Permit2612AmountMismatch.selector);
